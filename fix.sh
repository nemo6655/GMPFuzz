nano_sh="benchmark/mpfuzz_nanomq/run_mpfuzz.sh"
flash_sh="benchmark/mpfuzz_flashmq/run_mpfuzz.sh"
...
awk -v target_src="/home/ubuntu/experiments/nanomq-src/" -f temp.awk $nano_sh > temp1
mv temp1 $nano_sh
chmod +x $nano_sh

awk -v target_src="/home/ubuntu/experiments/FlashMQ" -f temp.awk $flash_sh > temp2
mv temp2 $flash_sh
chmod +x $flash_sh
